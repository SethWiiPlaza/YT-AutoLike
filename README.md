...
//
// (v7.7) added a jQuery ad-blocker ban bypass, added a function to not unlike a video you (or the script) already liked 
//            script fixes forced pauses on YouTube caused by Ad-Blockers, it also auto-likes every video you watch
//
//                 Works only on latest version of Firefox  
//                           >dependencies (jQuery)
